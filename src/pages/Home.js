  ...
  return (
    <div className="home page-content">
      <Helmet>
        ...
        <meta
          name="description"
          content="Leading SEO services in NZ. Transparent, no contracts & 100% performance based. Generate more leads & sales with Netbloom."
        />
        <meta
          property="og:title"
          content="Netbloom: SEO Services in NZ | Guaranteed Results"
        />
        <meta
          ...
          <div className="main-content">
            <div className="banner-con">
              ...
              <p>
                ...
                High-Impact SEO Services & Converting Web Design
              </p>
              <div className="flex-left btns">
                <Link to="#" className="gradientButton1 btn">
                  Get a Quote
                </Link>
                <Link
              ...
              >
                ...
                <Grid item xs={4} sm={4} md={4} data-aos="fade">
                  <div className="grid-item whiteBg">
                    ...
                    <h3>SEO</h3>
                    <p>
                      Find new clients organically and grow a foundation for
                      tomorrow.
                    </p>
                  </div>
                </Grid>
      ...
      <div className="default-sec why-trust bg-sec center">
        <div className="default-sec-overlay">
          <img
            src={network1}
            alt="network1"
            className="top-left spin net-img"
          />
          <img src={network} alt="network" className="bot-right spin net-img" />
          <div className="default-sec-content main-content">
            <div className="default-sec-wrap">
              <h2 data-aos="fade">
                Why Trust Netbloom For Your Digital Operations?
              </h2>
              <p className="sub-head">Quality Leads. Better Conversions.</p>
              <Grid
                container
              ...
              >
                <Grid item xs={12} sm={6} md={3} className="stretch">
                  <div className="grid-item">
                    <img
                      src={lightbulb}
                      alt="Work With Technical SEO Masters"
                    />
                ...
                <Grid item xs={12} sm={6} md={3} className="stretch">
                  <div className="grid-item">
                    <img
                      src={dashboard}
                      alt="Access Personalised Dashboard Reports"
                    />
                ...
                <Grid item xs={12} sm={6} md={3} className="stretch">
                  <div className="grid-item">
                    <img
                      src={deliveryservice}
                      alt="Enjoy A Service Package Tailored To You"
                    />
                ...
                <Grid item xs={12} sm={6} md={3} className="stretch">
                  <div className="grid-item">
                    <img
                      src={seo}
                      alt="Find The Solution That Fits Your Budget"
                    />
              ...
              >
                <Grid item xs={6}>
                  <div className="grid-item left-con">
                    <h2>
                      Are You Ready To Establish Your Presence In The Digital
                      World?
                    </h2>
                  </div>
                </Grid>
              ...
              >
                <Grid item xs={12} sm={12} md={3}>
                  <div className="grid-item left-con">
                    ...
                    <Link to="/case-studies" className="gradientButton1 btn">
            ...
            <div className="default-sec-wrap">
              ...
              >
                <Grid item xs={6}>
                  <div className="grid-item left-con">
                    <h2>
                      <span>Solutions</span> delivered using the best tools on
                      the best platforms
                    </h2>
                    <p>
                    ...
                    <Link to="/portfolio" className="gradientButton1 btn">
                      Our Portfolio
                    </Link>
                  </div>
                </Grid>
            ...
            <div className="default-sec-wrap bluePurpleGradient">
              ...
              >
                <Grid item xs={6}>
                  <div className="grid-item left-con">
                    <h2>
                      Take Your SEO To New Heights With Our Free Checklist
                    </h2>
                    <Link to="/checklist" className="gradientButton1 btn">
                      Get the Checklist
                    </Link>
                  </div>
                </Grid>
